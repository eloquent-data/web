...
export const tracks: Track[] = [
  {
    ...
    isActive: true,
    form_link:
      'https://docs.google.com/forms/d/e/1FAIpQLSfAHxjW5mVLHaw7nZc0M4sAWvBd_hmSsCLw0YmVgv3XNmi4UA/viewform',
...
export const testimonials: Testimonial[] = [
  {
    quote: 'I sharpened my data analysis skills and at the end of the program, I was about to research and publish an article on Credit risk analysis with python.',
    name: 'Paul Bananzi',
    country: '🇬🇭',
