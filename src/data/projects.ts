...
export const projects: Project[] = [
  {
    ...
    problem:
      'One of the major causes of the increasing spread of COVID-19 is gross misinformation spreading rapidly through social media platforms and other outlets. We are creating a resource hub that gives real-time visualization of COVID-19 and up-to-date information from credible sources such as WHO, UNICEF, Center for Disease',
  },
  {
    id: 2,
    ...
    problem:
      "Gender-Based violence is a recurring hazard that violates the rights of women in Africa and beyond. Stories of this targeted violence cut across various platforms in the domestic arena, online sexual exploitation, the workspace, etc. The UN  estimated that 2 out of  5 women have been subjected to one form of abuse or the other in Africa. Many studies show that all types of violence against women and girls, particularly domestic violence, have increased due to the COVID-19 pandemic thus a \"Shadow pandemic\" growth in violence against women and girls.",
  },
];
...
export const projects_detail: ProjectDetail[] = [
  {
    ...
    summary:
      'Virdash aims to flatten the curve of COVID-19 in Africa by providing real-time information and access to digital health tools.',
    desc: 'Wednesday 29th January 2020, the Novel Coronavirus was declared a Global Health Emergency by the World Health Organisation (WHO). On the 7th February 2020 the number of confirmed cases was 31,485 in over 28 countries, which rose to 71,811 by 17th February 2020 (ie over 128% in 10 days).</br>This project is to build an information hub for the 2019 novel coronavirus. This hub will contain interactive dashboard that gives a real-time visualization on the coronavirus and up-to-date information on its prevention.',
    problem:
    ...
    target:
      'We are targeting tech savvy Africans of ages ranging between 14-45 who make use of internet connection on their  IT gadgets to surf the web. They will gather enough information that they can pass to other Africans of other ages.',
    objective: `
      <h3>Community</h3>
      <ul>
        <li>
          <b>Information Distribution</b></br>
          Virdash will provide proper dissemination of  information to the public by way of education on prevention and symptoms to curb the spread of COVID-19
        </li>
        <li>
          <b>Accessibility</b></br>
          Virdash will provide access for people and community to access to digital health tools like telemedicine, interactive chatbot to any question about the virus and clarify rumour etc
        </li>
      </ul>
      </br>
      <h3>Government</h3>
      <ul>
        <li>
          ...
          With the report a case feature, we will be able to identify clusters of people having similar symptoms of the COVID-19 and alert the appropriate agency of such areas.
        </li>
        <li>
          <b>Tracking virus in Africa</b></br>
          A completed Virdash will help to document and report spread of viruses in Africa. Also track the distribution of vaccines and drugs on infectious diseases.
        </li>
      </ul>
      `,
  ...
  },
  {
    ...
    summary:
      'To build a platform that tackles the issues of GBV with data through storytelling and help victims overcome the trauma by providing both medical, mental and legal support through partnership.',
    desc: 'GBV is a global social problem that poses challenges in human health, with a higher prevalence in developing countries (Gender-Based Violence against Women in Sub-Saharan Africa: A Systematic Review and Meta-Analysis of Cross-Sectional Studies, International Journal of Environmental Research and Public Health). Many studies show that all types of violence against women and girls, particularly domestic violence, have increased due to the COVID-19 pandemic thus a <i>“Shadow pandemic”</i> growth in violence against women and girls.',
    problem:
      "Gender-Based violence is a recurring hazard that violates the rights of women in Africa and beyond. Stories of this targeted violence cut across various platforms in the domestic arena, online sexual exploitation, the workspace, etc. The UN  estimated that 2 out of  5 women have been subjected to one form of abuse or the other in Africa. Many studies show that all types of violence against women and girls, particularly domestic violence, have increased due to the COVID-19 pandemic thus a 'Shadow pandemic' growth in violence against women and girls.",
    solution:
      "The project aims to build a resource hub for data on Gender-Based Violence (GBV) in Africa, and also to proffer sustainable solutions through strategic partnership. </br> The GBV platform will include an interactive dashboard with data from different sources including but not limited to hospitals, surveys, social media, communities, ministries and parastatals. Also integrating our services into already existing women health applications.",
    target:
