...
const description =
  'At Eloquent Data, accessible from https://eloquentdata.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Eloquent Data and how we use it.';
...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Navbar title="Privacy Policy" description={description} />
      <TitleHeader title="Privacy Policy" />

      <div className="container my-7">
        <h1>Privacy Policy for Eloquent Data</h1>
        ...
        <h2>Log Files</h2>
        <p className="paragraph-small">
          Eloquent Data follows a standard procedure of using log files. These files log visitors
        ...
        <p className="paragraph-small">
          Like any other website, Eloquent Data uses 'cookies'. These cookies are used to store
        ...
        <p className="paragraph-small">
          For more general information on cookies, please read "What Are Cookies" from Cookie
          Consent.
        </p>
        ...
        <p className="paragraph-small">
          ...
          Beacons that are used in their respective advertisements and links that appear on Eloquent
          Data, which are sent directly to users' browser. They automatically receive your IP address
        ...
        <p className="paragraph-small">
          Note that Eloquent Data has no access to or control over these cookies that are used by
          third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>
        <p className="paragraph-small">
          Eloquent Data's Privacy Policy does not apply to other advertisers or websites. Thus, we
        ...
        <p className="paragraph-small">
          Eloquent Data does not knowingly collect any Personal Identifiable Information from
        ...
        <p className="paragraph-small">
          ...
          website with regards to the information that they shared and/or collect in Eloquent Data.
